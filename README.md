...
[Pieter Quinton](https://github.com/PGQuinton) ---  ([repo](https://github.com/PGQuinton/gov1006-finalproject-2.0), [pdf](https://github.com/GOV-1006-Spring-2020/papers/blob/master/papers/quinton_unemployment.pdf)) --- "Paul Bauer studies the relationship between unemployment and trust in the government and satisfaction with democracy. Bauer found that there were no consistent statistically significant results which I confirmed in my replication. I was able to completely replicate the majority of his findings aside from a summary table of the data. My extension looks to evaluate who consistent or long-term unemployment may impact one's views. Bauer restricted his analysis to a year by year basis while I will attempt to track trends over longer periods of time."
...
[Ruth Zheng](https://github.com/zhengruth) --- ([repo](https://github.com/zhengruth/milestone))[pdf](https://github.com/zhengruth/milestone/blob/master/When%20Renters%20Behave%20Like%20Homeowners.pdf) --- This is an extension and replication of Michael Hankinson's paper using exit polling and national survey data to answer the question of when renters demonstrate NIMBY behavior on par with home owners. Using regression with a conjoint, he finds that renters become more likely to oppose various affordable housing policies when they rent in high density and high price markets. For my extension, I will build a few new models using different regression techniques on the non-conjoint data sets. I will use logistic regression for binary respose variables (as opposed to lm) and consider interaction effects, such as whether rate of rent has a differential "effect" depending on the renter's distance from the proposed site of construction.  
