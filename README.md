...
[Cris Patvakanian](https://github.com/cpatvakanian) --- ([repo](https://github.com/cpatvakanian/milestone_6) [pdf](https://github.com/cpatvakanian/milestone_6/blob/master/milestone_6.pdf)) --- I am replicating “Vote Brokers, Clientelist Appeals, and Voter Turnout: Evidence from Russia and Venezuela” by Timothy Frye, Ora John Reuter and David Szakonyi. They analyze voting patterns and clientelism in Russia and Venezuela through the use of original survey data. All analysis for this paper be found in the original paper (https://www.cambridge.org/core/journals/world-politics/article/vote-brokers-clientelist-appeals-andvoter-turnout-evidence-from-russia-and-venezuela/45FE0BE1216FCD8744B02A82919B328A) and data verse (https://dataverse.harvard.edu/dataset.xhtml?persistentId=doi:10.7910/DVN/YSVMS2).
